...
def on_train_epoch_end(trainer):
    ...
    ##
    #_log_scalars({'train/loss': trainer.tloss.item(), 'train/accuracy': trainer.acc}, trainer.epoch + 1)
...
def on_fit_epoch_end(trainer):
    ...
    ##
    #_log_scalars({'val/loss': trainer.vloss.item(), 'val/accuracy': trainer.acc}, trainer.epoch + 1)
    #_log_scalars({'train/loss': trainer.tloss.item(), 'train/accuracy': trainer.acc}, trainer.epoch + 1)

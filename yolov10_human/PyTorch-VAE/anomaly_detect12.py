...
def main(vae_checkpoint_path, yolov10_checkpoint_path, input_image_path_pattern, output_dir, threshold=105):
    # Load models
        ...
        for image_path, img, results, original_shape in zip(batch_paths, batch_images, batch_results, original_shapes):
            ...
            for result in results:
                for box in result.boxes:
                    ...
                    if error > threshold:
                        # Anomaly detected
                        color = (0, 0, 255)  #  for anomaly
                        label = "Anomalous"
                    else:
                        # Normal
                        color = (255, 0, 0)  #  for normal
                        label = "Normal"
...
if __name__ == "__main__":
    ...
    output_dir = "/home/hkj/yolov10pj/yolov10_human/PyTorch-VAE/runs/train4_version57_thr105"

...
def main(vae_checkpoint_path, yolov10_checkpoint_path, input_image_path_pattern, output_dir, threshold=30):
    # Load models
        ...
        for image_path, img, results, original_shape in zip(batch_paths, batch_images, batch_results, original_shapes):
            ...
            for result in results:
                for box in result.boxes:
                    ...
                    # Compute PSNR
                    error = psnr(face_img_resized, recon_img)

                    # Print PSNR
                    print(f'PSNR for image {image_path} and box {box.xyxy[0]}: {error}')
...
if __name__ == "__main__":
    ...
    output_dir = "/home/hkj/yolov10pj/yolov10_human/PyTorch-VAE/runs/psnr"

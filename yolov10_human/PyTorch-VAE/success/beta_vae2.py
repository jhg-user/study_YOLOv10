...
class BetaVAE(BaseVAE):
    ...
    def __init__(self,
        ...
        # Adjusted for encoder output shape
    ...
    def encode(self, input: Tensor) -> List[Tensor]:
        ...
        print("Encoder output shape:", result.shape)  # Add this line to print the encoder output shape
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        result = result.view(-1, 512, 2, 2)  # Adjust the view to match the encoder output dimension

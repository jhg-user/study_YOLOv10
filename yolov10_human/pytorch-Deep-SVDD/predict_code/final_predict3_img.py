...
def main():
    ...
    image_path = '/home/hkj/yolov10pj/yolov10_human/dataset/test/*.jpg'
    output_path = '/home/hkj/yolov10pj/yolov10_human/pytorch-Deep-SVDD/runs/predict_deep'
    ...
    # 결과를 이미지에 표시
    draw_results(image_path, boxes, anomalies, output_path)

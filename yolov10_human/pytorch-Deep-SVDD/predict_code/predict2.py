...
def load_autoencoder_and_svdd(autoencoder_path, svdd_path, device):
    ...
    # Check if svdd_center_radius contains lists
    if isinstance(svdd_center_radius, dict):
        # Try to handle if center and radius are lists
        center = svdd_center_radius['center']
        radius = svdd_center_radius['radius']
...
#svdd_model_path = '/home/hkj/yolov10pj/yolov10_human/pytorch-Deep-SVDD/weights/pretrained_parameters.pth'
